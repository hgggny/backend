...
<body>
	...
	<!-- pattern을 0으로 하면 부족한 부분을 0으로 채워준다.  -->
	#을 이용해서 pattern 지정 : <fmt:formatNumber value="1.23" pattern="0.000"/><br>
	<!--  초과할 경우 반올림 -->
	#을 이용해서 pattern 지정 : <fmt:formatNumber value="1.2346" pattern="0.000"/><br><br>
	...
	백분율 : <fmt:formatNumber type="percent" value="1"/><br>
	...
	<ul>
		...
		<li>patthern : <fmt:formatDate type="both" pattern="YYYY-MM-dd(E) HH:mm:ss(a)" value="${ date }"/> </li>
	</ul>
</body>
</html>